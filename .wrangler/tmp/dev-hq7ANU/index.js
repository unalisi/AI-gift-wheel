...
// .wrangler/tmp/bundle-Xvidue/checked-fetch.js
  ...
  async fetch(request, env, ctx) {
    ...
    if (url.pathname === "/api/suggest" && request.method === "POST") {
      try {
        ...
        const systemPrompt = `Sen profesyonel ve yarat\u0131c\u0131 bir hediye dan\u0131\u015Fman\u0131s\u0131n. SADECE T\xDCRK\xC7E (Turkish) dilinde yan\u0131t vermen KES\u0130NL\u0130KLE ZORUNLUDUR. Hi\xE7bir ko\u015Fulda \u0130ngilizce kelime veya c\xFCmle kullanma. Yan\u0131tlar\u0131n her zaman numaraland\u0131r\u0131lm\u0131\u015F bir liste format\u0131nda olmal\u0131d\u0131r.`;
        const userPrompt = `Kullan\u0131c\u0131 Profili:
Ya\u015F Aral\u0131\u011F\u0131: ${yas}
Cinsiyet: ${cinsiyet}
B\xFCt\xE7e Aral\u0131\u011F\u0131: ${butce}
Vesile: ${vesile}
Ekstra Notlar: ${ekstraNot || "Yok"}
\xC7arktan \xC7\u0131kan Kategori: ${spinKategorisi}

L\xFCtfen yukar\u0131daki profile tam uygun, yarat\u0131c\u0131 ve spesifik 5 adet hediye \xF6nerisi yap. Her \xF6nerinin yan\u0131na (bu b\xFCt\xE7eye uygun olarak) tahmini fiyat\u0131n\u0131 ve bu hediyeyi neden se\xE7ti\u011Fini 1-2 c\xFCmle ile T\xDCRK\xC7E olarak a\xE7\u0131kla. Giri\u015F veya \xE7\u0131k\u0131\u015F c\xFCmlesi yazma, do\u011Frudan 1. maddeden ba\u015Fla.`;
        const messagesV1 = [
...
// .wrangler/tmp/bundle-Xvidue/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-Xvidue/middleware-loader.entry.ts
